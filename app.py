...
def infer_rubric_from_conversation(messages):
    ...
    system_prompt = """You are an expert writing coach and rubric designer. 
...
def analyze_preferences_and_generate_rubric(preferences, writing_task, criteria_info, base_rubric=None):
    ...
    system_prompt = """You are a rubric refinement specialist. Your task is to analyze user preferences 
            ...
            if compare_button:
                ...
                if last_user_message and selected_comparison:
                    ...
                    if 0 <= compare_idx < len(rubric_history):
                        ...
                        comparison_prompt = f"""Looking at this base draft:
                        
                        {last_assistant_content}

                        If I were to revise the base draft using Rubric v{st.session_state.comparison_rubric_version}, what specific changes would you make and why?

                        Provide:
                        1. Starting from the base draft, revice to meet Rubric v{st.session_state.comparison_rubric_version} and incorporate your suggestions.
                        ...
                        **CRITICAL - MANDATORY ANNOTATION REQUIREMENT:**
                        ...
                        ### Summary of Impact
                        - In 3–5 bullets, explain how Rubric v{st.session_state.comparison_rubric_version} affected tone, concision, evidence, structure, or polish.
                        - Mention any additions/deletions and why they were necessary for the rubric.
